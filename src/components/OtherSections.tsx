          ...
          <div className="farm-shell-panel flex flex-col md:flex-row justify-between items-start md:items-center p-6 border border-white/70 rounded-[1.6rem] shadow-sm gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium">Coordinate windbreaker blue gum, pasture paddocks, and operations logs for Tea, Avocado, Bananas, Corn & Sorghum.</p>
              </div>
            </div>
