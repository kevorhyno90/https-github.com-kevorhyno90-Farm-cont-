      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 z-10 relative">
        ...
        >
          <div className="flex justify-between items-start mb-3">
            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest font-sans">Agronomic Weather Advisory</span>
        ...
        >
          <div className="flex justify-between items-start mb-3">
            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest font-sans">Unified Alarm Center</span>
        ...
        >
          <div>
            <div className="flex justify-between items-start mb-3">
              <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest font-sans">App Shell Settings</span>
