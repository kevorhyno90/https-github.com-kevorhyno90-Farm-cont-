          ...
          <div className="bg-emerald-950 text-white p-6 rounded-3xl shadow-md border-t border-emerald-800 space-y-4 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 text-xs">
              ...
              >
                ...
                <span className={`text-[9px] block mt-1 ${loadedStep2 ? 'text-green-300' : 'text-slate-100'}`}>
              ...
              >
                ...
                <span className={`text-[9px] block mt-1 ${loadedStep3 ? 'text-green-300' : 'text-slate-100'}`}>
              ...
              {!useCustomFormula ? (
                ...
                >
                  ...
                  <span className={`text-[9px] block mt-1 ${loadedStep4 ? 'text-green-300' : 'text-slate-100'}`}>
                    ...
                    return (
                      <button
                        ...
                        className={`p-2.5 border rounded-xl flex items-center justify-between text-left transition-all cursor-pointer m-0 ${
                          isLoaded ? 'bg-emerald-800/80 border-green-500 text-white opacity-70' : 'bg-emerald-900/50 border-emerald-800 text-slate-300 hover:bg-emerald-900'
                        }`}
                      >
