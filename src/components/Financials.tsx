...
export function Financials({ 
  ...
  return (
    <div className="space-y-8 animate-fadeIn text-white">
      ...
      <div className="flex flex-wrap gap-2.5 p-1.5 bg-slate-900/40 backdrop-blur-md/70 rounded-2xl backdrop-blur-sm shadow-sm max-w-2xl text-xs border border-white/15">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-3 rounded-xl font-bold transition-all uppercase tracking-wider m-0 border-none cursor-pointer ${
            subTab === 'ledger' ? 'bg-slate-900/40 backdrop-blur-md text-white shadow-[0_4px_12px_rgb(0,0,0,0.05)] font-black' : 'text-slate-500 hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-3 rounded-xl font-bold transition-all uppercase tracking-wider m-0 border-none cursor-pointer ${
            subTab === 'analytics' ? 'bg-slate-900/40 backdrop-blur-md text-white shadow-[0_4px_12px_rgb(0,0,0,0.05)] font-black' : 'text-slate-500 hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-3 rounded-xl font-bold transition-all uppercase tracking-wider m-0 border-none cursor-pointer ${
            subTab === 'budgets' ? 'bg-slate-900/40 backdrop-blur-md text-white shadow-[0_4px_12px_rgb(0,0,0,0.05)] font-black' : 'text-slate-500 hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-3 rounded-xl font-bold transition-all uppercase tracking-wider m-0 border-none cursor-pointer ${
            subTab === 'breeding_roi' ? 'bg-slate-900/40 backdrop-blur-md text-white shadow-[0_4px_12px_rgb(0,0,0,0.05)] font-black' : 'text-slate-500 hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-4 py-3 rounded-xl font-bold transition-all uppercase tracking-wider m-0 border-none cursor-pointer ${
            subTab === 'granular_analysis' ? 'bg-slate-900/40 backdrop-blur-md text-white shadow-[0_4px_12px_rgb(0,0,0,0.05)] font-black' : 'text-slate-500 hover:text-white'
          }`}
        >
      ...
      <div className="bg-slate-900 text-white p-8 rounded-3xl border-8 border-double border-emerald-700/65 shadow-xl flex flex-col md:flex-row justify-between items-stretch gap-6 text-left">
        <div className="space-y-1.5 flex-1 flex flex-col justify-center">
          ...
          <p className="text-xs text-slate-500">Integrated audit accounting of all dynamic inputs/outgoes</p>
        </div>
      ...
      {subTab === 'ledger' && (
        <div className="space-y-8">
              ...
              <form onSubmit={handleIncomeSubmit} className="space-y-4 text-left">
                <div>
                  ...
                  <input
                    ...
                    className="text-xs border border-emerald-200 rounded-lg p-3 w-full font-bold bg-slate-900/40 backdrop-blur-md focus:ring-emerald-700/10 focus:outline-none"
                  />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="text-xs border border-emerald-200 rounded-lg p-3 w-full font-semibold bg-slate-900/40 backdrop-blur-md cursor-pointer focus:outline-none"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="text-xs border border-emerald-200 rounded-lg p-3 w-full font-medium bg-slate-900/40 backdrop-blur-md focus:outline-none"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="text-xs border border-emerald-200 rounded-lg p-3 w-full font-bold bg-slate-900/40 backdrop-blur-md font-mono cursor-pointer focus:outline-none"
                    />
                  </div>
                </div>
                <button
              ...
              <form onSubmit={handleExpenseSubmit} className="space-y-4 text-left">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Amount in Ksh"
                    className="text-xs border border-rose-200 rounded-lg p-3 w-full font-bold bg-slate-900/40 backdrop-blur-md focus:ring-rose-700/10 focus:outline-none"
                  />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="text-xs border border-rose-200 rounded-lg p-3 w-full font-semibold bg-slate-900/40 backdrop-blur-md cursor-pointer focus:outline-none"
                    >
                      <option value="">Choose category...</option>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="text-xs border border-rose-200 rounded-lg p-3 w-full font-medium bg-slate-900/40 backdrop-blur-md focus:outline-none"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="text-xs border border-rose-200 rounded-lg p-3 w-full font-bold bg-slate-900/40 backdrop-blur-md font-mono cursor-pointer focus:outline-none"
                    />
                  </div>
                </div>
                <button
          ...
          <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-3xl border border-white/15 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-500 space-y-4 text-left">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 border-b border-white/15 pb-4">
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium mt-0.5">Granular drilldown of all processed accounts</p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
                ...
                <div className="relative w-full sm:w-44">
                  ...
                  <input
                    ...
                    className="text-xs border border-white/15 bg-slate-800/40/50 rounded-xl pl-9 pr-4 py-2.5 w-full focus:outline-none focus:bg-slate-900/40 backdrop-blur-md font-bold"
                  />
                </div>
                ...
                <select
                  ...
                  className="text-xs border border-white/15 rounded-xl p-2.5 bg-slate-900/40 backdrop-blur-md cursor-pointer hover:bg-slate-800/40 active:scale-95 transition-all duration-300 ease-in-out focus:outline-none font-bold"
                >
              ...
              <div className="bg-teal-900/20 p-4 rounded-2xl border border-teal-100/50 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="text-xs border border-white/15 rounded-xl p-2.5 bg-slate-900/40 backdrop-blur-md w-full font-bold font-mono focus:outline-none"
                  />
                </div>
                <div>
            ...
            <div className="max-h-[400px] overflow-auto pr-1">
              <table className="w-full text-xs">
                <thead>
                  <tr className="border-b border-white/15 bg-slate-800/40 text-slate-500 text-[10px] uppercase font-black">
                  ...
                  {filteredRecords.length === 0 ? (
                    <tr>
                      <td colSpan={5} className="text-center py-10">
                        <div className="max-w-md mx-auto bg-slate-800/40 border border-white/15 rounded-2xl p-5 space-y-2">
                          <p className="text-slate-200 font-bold text-sm">No ledger rows match the current filters.</p>
                          ...
                          {hasActiveLedgerFilters && (
                            <button
                              ...
                              className="mt-2 inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-900/40 backdrop-blur-md border border-white/15 text-slate-200 text-xs font-bold hover:bg-slate-800/60 cursor-pointer"
                            >
                              <RefreshCw size={12} />
                              Clear Filters
                            </button>
                    ...
                    filteredRecords.map((r) => (
                      <tr key={r.id} className="border-b border-slate-50 hover:bg-slate-800/40/30 active:scale-95 transition-all duration-300 ease-in-out">
                        <td className="p-3 font-mono text-slate-500 font-bold">{r.date}</td>
                        <td className="p-3">
                        ...
                        <td className="p-3 font-medium text-slate-500 max-w-xs truncate" title={r.description}>
                          {r.description}
                        </td>
                          ...
                          <div className="flex items-center justify-center gap-1.5">
                            {onEditFinancialRecord && (
                              <button
                                ...
                                className="text-slate-300 hover:text-indigo-800 p-2 border border-transparent hover:border-white/15 rounded-lg transition-colors cursor-pointer m-0 bg-transparent"
                                title="Edit entry"
                              >
                                <Edit2 size={13} />
                              </button>
                            ...
                            <button
                              ...
                              className="text-slate-300 hover:text-emerald-800 p-2 border border-transparent hover:border-white/15 rounded-lg transition-colors cursor-pointer m-0 bg-transparent"
      ...
      {subTab === 'analytics' && (
        <div className="space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            {/* Timeline AreaChart */}
            <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-3xl border border-white/15 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-500 lg:col-span-8 space-y-4 text-left">
              <div>
                ...
                <p className="text-xs text-slate-500 font-medium mt-0.5">Visualize monthly balance fluctuations and operational profit margins</p>
              </div>

              {monthlyChartData.length === 0 ? (
                <div className="h-[280px] flex items-center justify-center bg-slate-800/40 border border-white/15 rounded-2xl italic text-slate-500 text-xs">
            ...
            <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-3xl border border-white/15 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-500 lg:col-span-4 flex flex-col justify-between text-left">
              <div className="space-y-4">
                <div>
                  <h5 className="text-[11px] font-black tracking-widest text-[#0c2619] uppercase">Revenue Sources split</h5>
                  <p className="text-xs text-slate-500 font-medium mt-0.5">Where farm profits derive</p>
                </div>
                  ...
                  return (
                    <div key={idx} className="flex justify-between items-center">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="truncate max-w-[120px] text-slate-500">{item.name}</span>
                      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 text-left">
            <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-3xl border border-white/15 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-500 space-y-4">
              <div>
                <h5 className="text-[11px] font-black tracking-widest text-rose-950 uppercase">Capital Expenditures Allocation (Ksh)</h5>
                <p className="text-xs text-slate-500 font-medium mt-0.5">Distribution of debits across farm operations</p>
              </div>

              {expenseCategoryData.length === 0 ? (
                <div className="h-[220px] flex items-center justify-center text-slate-500 text-xs italic">
            ...
            <div className="bg-slate-900 text-white p-6 rounded-3xl border border-slate-800 shadow-md flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <div className="bg-slate-800/80 p-5 rounded-2xl flex items-center justify-between border border-slate-705/30">
                  <div>
                    <span className="text-[9px] text-slate-500 block uppercase font-bold">Calculated Operating Quotient</span>
                  ...
                  <div>
                    <span className="text-[9px] text-slate-500 block uppercase font-bold text-right">Standard Threshold limit</span>
                    <span className="text-emerald-400 font-mono font-black text-right block mt-1">40% Max target</span>
                  </div>
                </div>
              </div>

              <div className="pt-4 border-t border-slate-800/80 text-[10px] text-slate-500 font-semibold leading-relaxed">
                {totalIncome === 0 ? (
          ...
          <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-3xl border border-white/15 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-500 text-left space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium mt-0.5">Comparative review of net profits and estimated ROI percentages across farm sectors</p>
            </div>
      ...
      {subTab === 'budgets' && (
        <div className="bg-slate-900/40 backdrop-blur-md p-8 rounded-3xl border border-white/15 shadow-sm space-y-6 text-left">
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium mt-0.5">Set monthly maximum allocation thresholds, review actual expenditures, and isolate over-spending on-the-fly.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
              ...
              {Object.entries(budgetCaps).map(([category, rawCap], index) => {
                ...
                const textColor = pct > 100 ? 'text-red-700 font-black' : (pct >= 70 ? 'text-amber-700' : 'text-slate-500');
                ...
                return (
                  <div key={index} className="space-y-1.5 font-sans">
                    ...
                    <div className="h-3 w-full bg-slate-800/60 rounded-full overflow-hidden relative border border-white/15">
            ...
            <div className="bg-slate-800/40 border border-white/15 rounded-3xl p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {Object.entries(budgetCaps).map(([category, cap], index) => (
                  <div key={index}>
                    <label className="text-[9px] text-slate-500 font-bold block mb-1 uppercase truncate" title={category}>
                      {category} (Ksh)
                    </label>
                    <input
                      type="number"
                      ...
                      className="text-xs font-mono font-bold bg-slate-900/40 backdrop-blur-md border border-slate-205 rounded-xl p-2.5 w-full focus:ring-1 focus:ring-rose-800 focus:outline-none"
                    />
                  </div>
                ))}
              </div>

              <div className="p-3.5 bg-[#0e301d]/5 rounded-2xl border border-[#0e301d]/10 text-[10px] text-slate-500 uppercase font-bold leading-normal flex items-start gap-2.5">
      ...
      {subTab === 'breeding_roi' && (
        <div className="space-y-8 text-left">
          <div className="bg-slate-900/40 backdrop-blur-md p-8 rounded-3xl border border-white/15 shadow-sm space-y-6">
            <div>
              <div className="flex justify-between items-start flex-wrap gap-2">
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-medium mt-0.5">Smart forecasting algorithm cross-linking artificial insemination timelines with upcoming lactation peak revenues.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-slate-800/40 border border-white/15 p-4.5 rounded-2xl">
                <span className="text-[9px] text-slate-500 font-extrabold uppercase block tracking-wider">Pregnant Milking Cows</span>
                <h3 className="text-2xl font-black font-mono text-emerald-900 mt-1">{breedingPredictionData.activePregnancies} Head</h3>
                <span className="text-[10px] text-slate-500 font-medium block pt-1">Calving over next 90 days</span>
              </div>

              <div className="bg-slate-800/40 border border-white/15 p-4.5 rounded-2xl">
                <span className="text-[9px] text-slate-500 font-extrabold uppercase block tracking-wider">Unchecked Cycles</span>
                <h3 className="text-2xl font-black font-mono text-indigo-950 mt-1">{breedingPredictionData.pendingServices} In-waiting</h3>
                <span className="text-[10px] text-slate-500 font-medium block pt-1">Awaiting veterinary check</span>
              </div>

              <div className="bg-slate-800/40 border border-white/15 p-4.5 rounded-2xl">
                <span className="text-[9px] text-slate-500 font-extrabold uppercase block tracking-wider">Est. Peak Lactation Yield</span>
                <h3 className="text-2xl font-black font-mono text-teal-900 mt-1">+{breedingPredictionData.projectedLiters.toLocaleString()} L</h3>
                <span className="text-[10px] text-slate-500 font-medium block pt-1">Based on breed targets (90d)</span>
              </div>
            ...
            {/* Price model slider */}
            <div className="bg-slate-800/40 border border-white/15 rounded-2xl p-5 space-y-2">
              ...
              <input
                ...
                className="w-full h-1 appearance-none bg-slate-800/80 rounded-lg cursor-pointer accent-emerald-800"
              />
              <div className="flex justify-between text-[9px] text-slate-500 font-bold uppercase tracking-wide">
            ...
            <div className="space-y-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs">
                  <thead>
                    <tr className="border-b border-white/15 text-[9.5px] uppercase font-black text-slate-500">
                  ...
                  <tbody className="divide-y divide-slate-50 font-medium text-slate-650">
                    {breedingPredictionData.upcomingCalvings.map((c, i) => {
                      const daysColor = c.daysLeft <= 30 ? 'text-red-700 font-black' : (c.daysLeft <= 60 ? 'text-amber-705 text-amber-700' : 'text-slate-500');
                      const peakDaily = c.breed.toLowerCase().includes('friesian') ? 28 : (c.breed.toLowerCase().includes('jersey') ? 19 : 24);
                      const expectedSum = peakDaily * 90 * activeMarketMilkPrice;

                      return (
                        <tr key={i} className="hover:bg-slate-800/40/50 active:scale-95 transition-all duration-300 ease-in-out">
      ...
      {subTab === 'granular_analysis' && (
        <div className="space-y-8 text-left animate-fadeIn">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            <div className="bg-slate-900/40 backdrop-blur-md border border-white/15 rounded-2xl p-5 shadow-xs">
          ...
          <div className="bg-slate-800/60 p-1.5 rounded-2xl border border-white/15 flex w-full max-w-md">
            <button
              ...
              className={`flex-1 py-3 text-xs uppercase tracking-wider font-extrabold rounded-xl transition-all m-0 cursor-pointer border-none ${
                granularViewMode === 'cow' ? 'bg-slate-900/40 backdrop-blur-md text-white shadow-sm' : 'text-slate-500 hover:text-white'
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 py-3 text-xs uppercase tracking-wider font-extrabold rounded-xl transition-all m-0 cursor-pointer border-none ${
                granularViewMode === 'block' ? 'bg-slate-900/40 backdrop-blur-md text-white shadow-sm' : 'text-slate-500 hover:text-white'
              }`}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-8 bg-slate-900/40 backdrop-blur-md border border-white/15 rounded-3xl p-6 shadow-xs space-y-4">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs">
                  <thead>
                    <tr className="border-b border-slate-150 text-[9.5px] uppercase font-black text-slate-500">
                        ...
                        return (
                          <tr key={i} className="hover:bg-slate-800/40/50 active:scale-95 transition-all duration-300 ease-in-out">
                            <td className="py-3.5 flex flex-col">
                              ...
                              <span className="text-[8px] bg-slate-800/60 text-slate-500 font-extrabold uppercase px-1.5 py-0.5 rounded-sm mt-1 self-start">
                                {c.status}
                              </span>
                            </td>
            ...
            <div className="lg:col-span-4 space-y-6">
              {/* Chart Comparison */}
              <div className="bg-slate-900/40 backdrop-blur-md border border-white/15 rounded-3xl p-6 shadow-xs space-y-4">
      ...
      {editingFinancial && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-slate-900/40 backdrop-blur-md rounded-3xl w-full max-w-md shadow-2xl p-6 border border-white/15 space-y-4 animate-fadeIn text-left">
            <div className="flex justify-between items-center pb-2 border-b border-white/15">
              ...
              <button onClick={() => setEditingFinancial(null)} className="text-slate-500 hover:text-slate-500 font-bold m-0 cursor-pointer bg-transparent border-none">✕</button>
            </div>
            ...
            <div className="flex justify-end gap-2 border-t border-white/15 pt-4">
              <button
                ...
                className="px-4 py-2 border border-white/15 rounded-lg text-xs font-bold text-slate-500 hover:bg-slate-800/40 active:scale-95 transition-all duration-300 ease-in-out m-0 cursor-pointer bg-transparent"
              >
                Cancel
              </button>
              <button
      ...
      {selectedInvoiceTx && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-[999]">
          <div className="bg-slate-900/40 backdrop-blur-md max-w-md w-full rounded-3xl border border-white/15 shadow-2xl p-8 text-left space-y-6 relative">
            <button
              onClick={() => setSelectedInvoiceTx(null)}
              className="absolute top-4 right-4 p-2 text-slate-500 hover:text-slate-500 rounded-full hover:bg-slate-800/60 active:scale-95 transition-all duration-300 ease-in-out cursor-pointer border-none bg-transparent"
            >
              <X size={18} />
            </button>
            ...
            <div id="printable-invoice" className="space-y-6 p-2">
              <div className="text-center border-b border-white/15 pb-5">
                ...
                <p className="text-[10px] text-slate-500 font-mono mt-1 font-bold">Transaction Ref: {selectedInvoiceTx.id}</p>
              </div>
 
              <div className="space-y-4 text-xs">
                <div className="flex justify-between border-b border-slate-50 pb-2">
                  <span className="text-slate-500 font-bold uppercase">Transaction Date</span>
                  <span className="font-mono font-bold text-slate-200">{selectedInvoiceTx.date}</span>
                </div>
                <div className="flex justify-between border-b border-slate-50 pb-2">
                  <span className="text-slate-500 font-bold uppercase">Account Class</span>
                  <span className="font-black text-white uppercase">{selectedInvoiceTx.category}</span>
                </div>
                <div className="flex justify-between border-b border-slate-50 pb-2">
                  <span className="text-slate-500 font-bold uppercase">Flow Direction</span>
                ...
                <div className="space-y-1">
                  <span className="text-slate-500 font-bold uppercase block text-[10px]">Description & Auditing Details</span>
                  <p className="p-3 bg-slate-800/40 rounded-xl font-medium text-slate-200 leading-normal">{selectedInvoiceTx.description}</p>
                </div>
              ...
              <div className="text-center text-[9px] text-slate-500 font-bold uppercase tracking-wider pt-4 border-t border-dashed border-white/15">
            ...
            <div className="flex gap-2">
              <button
                onClick={() => setSelectedInvoiceTx(null)}
                className="w-1/2 py-2.5 border border-white/15 text-slate-500 rounded-xl text-xs font-black uppercase tracking-wider hover:bg-slate-800/40 active:scale-95 transition-all duration-300 ease-in-out cursor-pointer"
              >
                Close
              </button>
              <button
                onClick={() => {
                  ...
                  if (printContents) {
                    ...
                    if (printWindow) {
                      ...
                      printWindow.document.write('<style>body{font-family:sans-serif;padding:20px;color:#333;}.text-center{text-align:center;}.font-mono{font-family:monospace;}.flex{display:flex;justify-content:space-between;}.border-b{border-bottom:1px solid #eee;}.pb-2{padding-bottom:8px;}.pb-5{padding-bottom:20px;}.pt-4{padding-top:16px;}.space-y-4>*{margin-bottom:12px;}.bg-slate-800/40{background:#f8fafc;padding:12px;border-radius:8px;}</style></head><body>');
