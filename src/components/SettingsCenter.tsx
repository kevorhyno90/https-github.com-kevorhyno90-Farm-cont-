  ...
  return (
    <div className="space-y-8 animate-fadeIn text-white" id="system-settings-panel">
      ...
      <div className="farm-shell-panel p-6 rounded-[1.6rem] border border-white/70 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-left">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="px-4 py-2 bg-slate-900/40 backdrop-blur-md hover:bg-rose-900/20 border border-slate-205 text-slate-200 hover:text-rose-700 text-xs uppercase tracking-wider font-extrabold rounded-xl transition-all cursor-pointer flex items-center gap-2 m-0"
          >
            <RotateCcw size={13} />
            Hard Reset
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-3 bg-slate-900/40 backdrop-blur-md border border-slate-150 rounded-3xl overflow-hidden p-3 shadow-xs space-y-1">
          <span className="text-[10px] font-black uppercase text-slate-500 px-3 py-2 block tracking-widest text-left">Parameter Sectors</span>
          {menuItems.map(item => {
              ...
              <button
                ...
                className={`w-full py-3 px-3.5 rounded-xl text-xs font-black uppercase tracking-wider flex items-center gap-3 transition-all duration-150 cursor-pointer m-0 border-0 ${
                  isActive 
                    ...
                    : 'text-slate-500 hover:bg-slate-800/40 hover:text-slate-905'
                }`}
              >
                <div className={`p-1.5 rounded-lg shrink-0 ${isActive ? 'bg-slate-900/40 backdrop-blur-md/10 text-white' : item.color}`}>
                  <Icon size={14} />
                </div>
        ...
        <div className="lg:col-span-9 bg-slate-900/40 backdrop-blur-md border border-slate-150 rounded-3xl p-6 md:p-8 shadow-xs text-left text-white">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 font-sans">
                <div>
                  ...
                  <input
                    ...
                    className="border border-white/15 rounded-xl p-3 w-full text-xs font-bold focus:ring-1 focus:ring-emerald-500 bg-slate-800/40/50"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="border border-white/15 rounded-xl p-3 w-full text-xs font-bold focus:ring-1 focus:ring-emerald-500 bg-slate-800/40/50 font-mono"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 font-sans">
                <div>
                  ...
                  <input
                    ...
                    className="border border-white/15 rounded-xl p-3 w-full text-xs font-mono font-bold focus:ring-1 focus:ring-emerald-500 bg-slate-800/40/50"
                  />
                </div>
                <div>
          ...
          {activeSubSection === 'system' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-slate-800/40 border border-white/15 rounded-2xl p-4 space-y-4">
                <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="bg-slate-900/40 backdrop-blur-md p-3 rounded-xl border border-white/15 flex flex-col justify-between text-left">
                    <div>
                      <span className="text-[9px] uppercase font-bold text-slate-500 block">Cloud API Signal</span>
                      
                      {/* Visual Indicator of Current Origin */}
                      <span className="text-[9px] font-mono text-slate-500 block break-all font-semibold mt-0.5 bg-slate-800/60 p-1 rounded">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        {connState === 'checking' && (
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[11px] font-bold text-slate-500">Querying Server Status...</span>
                          </div>
                        )}
                        {connState === 'online' && (
                          <div className="flex items-center gap-1.5">
                  ...
                  <div className="bg-slate-900/40 backdrop-blur-md p-3 rounded-xl border border-white/15 flex flex-col justify-between text-left">
                    <div>
                      <span className="text-[9px] uppercase font-bold text-slate-500 block">Mobile PWA Cache Status</span>
                  ...
                  <div className="bg-slate-900/40 backdrop-blur-md p-3 rounded-xl border border-white/15 flex flex-col justify-between text-left sm:col-span-2">
                    <div>
                      <span className="text-[9px] uppercase font-bold text-slate-500 block">Cloud Sync Control</span>
                      <p className="text-[9.5px] text-slate-500 leading-normal font-semibold mt-1">
                    ...
                    <div className="mt-3 flex items-center justify-between gap-3">
                      <div className="text-[10px] font-black uppercase tracking-wide text-slate-200">
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-[10px] uppercase font-black tracking-wide border transition-colors cursor-pointer ${
                          !isFirestoreSyncEnabled
                            ? 'bg-slate-800/60 border-white/15 text-slate-500 cursor-not-allowed'
                            : cloudSyncEnabled
              ...
              <div className="bg-slate-900/40 backdrop-blur-md rounded-3xl p-6 shadow-sm border border-white/10 mb-6">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-slate-800/40 rounded-2xl border border-white/10 flex items-center justify-between">
                    <div>
              ...
              <div className="pt-4 border-t border-white/10 flex flex-wrap gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-slate-800/60 hover:bg-slate-800/80 text-white text-xs font-extrabold uppercase tracking-wider rounded-xl transition-all cursor-pointer border-0 flex items-center gap-2"
                >
                  <Download size={13} />
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              {isInIframe ? (
                <div className="bg-amber-900/20 border border-amber-200/80 p-5 rounded-2xl space-y-3.5 text-left">
                  ...
                  <div className="bg-slate-900/40 backdrop-blur-md/80 p-3 rounded-xl border border-amber-150 text-[11px] font-semibold text-slate-200 leading-relaxed">
              ...
              <div className="bg-slate-800/40 border border-slate-150 rounded-2xl p-4 space-y-3 text-left">
                <span className="text-[10px] font-black uppercase text-slate-500 tracking-wider block">App Eligibility & Diagnostics</span>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  <div className="bg-slate-900/40 backdrop-blur-md p-3 rounded-xl border border-white/15 flex items-center justify-between">
                    <div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {/* Google Chrome */}
                  <div className="bg-slate-900/40 backdrop-blur-md p-4 rounded-xl border border-white/15 space-y-2 text-left">
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* Android Phone */}
                  <div className="bg-slate-900/40 backdrop-blur-md p-4 rounded-xl border border-white/15 flex gap-4 text-left">
          ...
          {activeSubSection === 'playstore' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-slate-800/40 border border-slate-150 p-5 rounded-2xl space-y-4">
                <h6 className="text-[11px] font-black uppercase text-white flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 font-sans">
                  <div>
                    ...
                    <input
                      ...
                      className="border border-white/15 rounded-xl p-2.5 w-full text-xs font-mono font-bold focus:ring-1 focus:ring-blue-500 bg-slate-900/40 backdrop-blur-md"
                      placeholder="e.g. com.company.app"
                    />
                    <span className="text-[9px] text-slate-500 font-semibold block mt-1">Unique global ID for Play Store URL listing</span>
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="border border-white/15 rounded-xl p-2.5 w-full text-xs font-bold focus:ring-1 focus:ring-blue-500 bg-slate-900/40 backdrop-blur-md"
                      placeholder="e.g. JR Farm Omni-Estate Manager"
                    />
                    <span className="text-[9px] text-slate-500 font-semibold block mt-1">Official user-facing app name on Google Play</span>
                  </div>
                </div>
                      ...
                      <button
                        ...
                        className={`p-3 rounded-xl border text-left flex flex-col justify-between cursor-pointer transition-all m-0 ${
                          settings.monetizationStrategy === st.id 
                            ...
                            : 'bg-slate-900/40 backdrop-blur-md border-white/15 hover:border-slate-350 text-slate-200'
                        }`}
                      >
                ...
                {settings.monetizationStrategy === 'Ad Supported (AdMob)' && (
                  <div className="bg-slate-900/40 backdrop-blur-md border border-white/15 p-4 rounded-xl space-y-3 animate-fadeIn">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 font-sans">
                      <div>
                        <label className="text-[9px] font-bold text-slate-500 uppercase block mb-1">AdMob Banner Unit ID</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="text-[9px] font-bold text-slate-500 uppercase block mb-1">AdMob Interstitial Unit ID</label>
                        <input
                          type="text"
                ...
                {settings.monetizationStrategy === 'Premium Paid' && (
                  <div className="bg-slate-900/40 backdrop-blur-md border border-white/15 p-4 rounded-xl space-y-3 animate-fadeIn w-full sm:w-1/2 font-sans">
              ...
              <div className="bg-slate-900/40 backdrop-blur-md border border-slate-150 p-5 rounded-2xl space-y-4">
                <div className="flex justify-between items-center border-b pb-2">
                  <h6 className="text-[11px] font-black uppercase text-white flex items-center gap-1.5">
                    <CheckCircle2 size={13} className="text-emerald-600" />
                    2. Google Play Store Launch Action Sequence
                  </h6>
                  <span className="text-[9px] bg-slate-800/60 px-2.5 py-1 rounded font-mono font-bold text-slate-500">
                    ...
                    <div 
                      ...
                      className={`p-3 rounded-xl border flex items-start gap-3 cursor-pointer transition-colors duration-200 select-none ${
                        checklistCompleted[task.id] 
                          ...
                          : 'bg-slate-900/40 backdrop-blur-md hover:bg-slate-800/40/50'
                      }`}
                    >
                      <input 
                        type="checkbox"
