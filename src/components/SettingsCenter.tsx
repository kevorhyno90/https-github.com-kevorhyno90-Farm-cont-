...
export function SettingsCenter({ onSaveConfig, onResetAllData }: SettingsProps) {
 ...
 const menuItems = [
 { id: 'estate', label: 'Estate Identity', icon: Building, color: 'text-emerald-700 bg-emerald-900/20' },
 ...
 { id: 'pwa', label: 'PC & Mobile Install', icon: Monitor, color: 'text-teal-700 bg-teal-900/20' },
 { id: 'playstore', label: 'Play Store & Monetize', icon: Smartphone, color: 'text-blue-700 bg-blue-900/20' }
 ] as const;

 return (
 <div className="space-y-8 animate-fadeIn text-white" id="system-settings-panel">
 ...
 <div>
 <h4 className="text-white font-black text-sm uppercase tracking-wider">Estate Control Settings Center</h4>
 ...
 className="px-4 py-2 bg-slate-900 hover:bg-rose-900/20 border border-slate-205 text-white font-semibold hover:text-rose-700 text-xs uppercase tracking-wider font-extrabold rounded-xl transition-all cursor-pointer flex items-center gap-2 m-0"
 >
 <RotateCcw size={13} />
 Hard Reset
 </button>
 ...
 <div className="lg:col-span-3 bg-slate-900 border border-slate-150 rounded-3xl overflow-hidden p-3 shadow-xs space-y-1">
 <span className="text-[10px] font-black uppercase text-white font-medium font-medium px-3 py-2 block tracking-widest text-left">Parameter Sectors</span>
 {menuItems.map(item => {
 ...
 : 'text-white font-medium font-medium hover:bg-slate-800 hover:text-slate-905'
 }`}
 >
 <div className={`p-1.5 rounded-lg shrink-0 ${isActive ? 'bg-slate-900 /10 text-white' : item.color}`}>
 <Icon size={14} />
 </div>
 ...
 <div className="lg:col-span-9 bg-slate-900 border border-slate-150 rounded-3xl p-6 md:p-8 shadow-xs text-left text-white">
 
 {/* Tab 1: Estate Identity */}
 {activeSubSection === 'estate' && (
 <div className="space-y-6 animate-fadeIn">
 <div className="border-b pb-3.5">
 <h5 className="text-sm font-black uppercase text-white">Estate Identity & Authorization</h5>
 ...
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Estate Corporate Name</label>
 <input
 type="text"
 value={settings.estateName}
 onChange={(e) => handleUpdate('estateName', e.target.value)}
 className="border border-white/15 rounded-xl p-3 w-full text-xs font-bold focus:ring-1 focus:ring-emerald-500 bg-slate-800/50"
 />
 </div>
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Lead Farm Comptroller / Administrator</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Registered GlobalGAP Plot / Code</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Local Currency Abbreviation</label>
 <input
 type="text"
 value={settings.currency}
 onChange={(e) => handleUpdate('currency', e.target.value)}
 className="border border-white/15 rounded-xl p-3 w-full text-xs font-bold focus:ring-1 focus:ring-emerald-500 bg-slate-800/50 font-mono"
 />
 </div>
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Farm Latitude (Degree Decimal)</label>
 <input
 type="number"
 step="0.0001"
 ...
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Farm Longitude (Degree Decimal)</label>
 <input
 type="number"
 step="0.0001"
 ...
 <div className="bg-emerald-900/20 p-4 rounded-2xl border border-emerald-100 flex items-start gap-3 mt-4">
 ...
 <div className="space-y-6 animate-fadeIn">
 <div className="border-b pb-3.5">
 <h5 className="text-sm font-black uppercase text-white">Crop Valuation & Sales baselines</h5>
 <p className="text-[11px] text-slate-450 mt-1 font-semibold leading-relaxed">
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 font-sans">
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Avocado Monthly Export Volume Target (KG)</label>
 <input
 type="number"
 value={settings.avocadoTargetVolume}
 onChange={(e) => handleUpdate('avocadoTargetVolume', parseFloat(e.target.value) || 0)}
 className="border border-white/15 rounded-xl p-3 w-full text-xs font-mono font-bold focus:ring-1 focus:ring-emerald-500 bg-slate-800/50"
 />
 </div>
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Tea Sales Contract Price (Ksh per KG)</label>
 <input
 type="number"
 ...
 <div className="bg-indigo-900/20 p-4 rounded-2xl border border-indigo-100 flex items-start gap-3 mt-4">
 ...
 <div className="space-y-6 animate-fadeIn">
 <div className="border-b pb-3.5">
 <h5 className="text-sm font-black uppercase text-white">Dairy & Gestation Wheel Calibration</h5>
 <p className="text-[11px] text-slate-450 mt-1 font-semibold leading-relaxed">
 ...
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Average Daily Milk Target per Cow (L)</label>
 <input
 type="number"
 step="0.1"
 ...
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Dry-off Gestation Threshold Day</label>
 <input
 type="number"
 ...
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Standard Cattle Gestation Duration</label>
 <input
 type="number"
 ...
 <div className="bg-amber-900/20 p-4 rounded-2xl border border-amber-100 flex items-start gap-3 mt-4">
 ...
 <div className="space-y-6 animate-fadeIn">
 <div className="border-b pb-3.5">
 <h5 className="text-sm font-black uppercase text-white">System Integration & Simulation Engine</h5>
 <p className="text-[11px] text-slate-450 mt-1 font-semibold leading-relaxed">
 ...
 <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 font-sans">
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Interactive Speed Calibration</label>
 <select
 ...
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Roster & Lactation Logs Auto-Seeder</label>
 <select
 ...
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1.5">Mobile Auto-Rotate & Screen Turn</label>
 <select
 ...
 <p className="text-[9px] text-amber-700 font-semibold leading-normal mt-1.5 bg-amber-900/20 border border-amber-200 p-2 rounded-lg">
 ...
 <div className="bg-slate-800 border border-white/15 rounded-2xl p-4 space-y-4">
 <div>
 <h6 className="text-[11px] font-black uppercase text-white flex items-center gap-1.5">
 <Wifi size={13} className="text-emerald-700 font-bold" />
 Cloud Server & Mobile App Sync Diagnostics
 </h6>
 <p className="text-[10px] text-white font-medium font-medium leading-normal font-semibold mt-0.5">
 ...
 <div className="bg-slate-900 p-3 rounded-xl border border-white/15 flex flex-col justify-between text-left">
 <div>
 <span className="text-[9px] uppercase font-bold text-white font-medium font-medium block">Cloud API Signal</span>
 
 {/* Visual Indicator of Current Origin */}
 <span className="text-[9px] font-mono text-white font-medium font-medium block break-all font-semibold mt-0.5 bg-slate-800 p-1 rounded">
 App Host: {typeof window !== 'undefined' ? window.location.origin : 'Loading origin...'}
 </span>

 <div className="flex items-center gap-2 mt-2">
 {connState === 'idle' && (
 <span className="text-[11px] font-bold text-white font-medium font-medium">Not Tested</span>
 )}
 {connState === 'checking' && (
 <div className="flex items-center gap-1.5">
 <RefreshCw size={11} className="animate-spin text-white font-medium font-medium" />
 <span className="text-[11px] font-bold text-white font-medium font-medium">Querying Server Status...</span>
 </div>
 )}
 {connState === 'online' && (
 <div className="flex items-center gap-1.5">
 ...
 {connState === 'online' && (
 <div className="mt-2 text-[10px] leading-relaxed bg-emerald-900/20 border border-emerald-100 p-1.5 rounded-lg text-emerald-850 font-medium">
 {aiInitialized ? (
 ...
 {connState === 'error' && (
 <div className="mt-2 text-[10px] leading-normal bg-rose-900/20 border border-rose-100 p-1.5 rounded-lg text-rose-800 font-semibold space-y-1">
 ...
 <div className="bg-slate-900 p-3 rounded-xl border border-white/15 flex flex-col justify-between text-left">
 <div>
 <span className="text-[9px] uppercase font-bold text-white font-medium font-medium block">Mobile PWA Cache Status</span>
 <p className="text-[9.5px] text-white font-medium font-medium leading-normal font-semibold mt-1">
 ...
 <div className="bg-slate-900 p-3 rounded-xl border border-white/15 flex flex-col justify-between text-left sm:col-span-2">
 <div>
 <span className="text-[9px] uppercase font-bold text-white font-medium font-medium block">Cloud Sync Control</span>
 <p className="text-[9.5px] text-white font-medium font-medium leading-normal font-semibold mt-1">
 Use this switch to pause/resume Firestore cloud sync without editing code.
 </p>
 {!isFirestoreSyncEnabled && (
 <p className="text-[9px] mt-2 text-amber-800 bg-amber-900/20 border border-amber-200 rounded-lg p-2 font-semibold">
 ...
 <div className="text-[10px] font-black uppercase tracking-wide text-white font-semibold">
 ...
 !isFirestoreSyncEnabled
 ? 'bg-slate-800 border-white/15 text-white font-medium font-medium cursor-not-allowed'
 : cloudSyncEnabled
 ? 'bg-emerald-900/20 border-emerald-200 text-emerald-800 hover:bg-emerald-100'
 ...
 <div className="bg-slate-900 rounded-3xl p-6 shadow-sm border border-white/10 mb-6">
 ...
 <div>
 <div className="font-bold text-white">Switch Account / Sign Out</div>
 <div className="text-xs text-white font-medium font-medium mt-1">Leave the current database room and return to the login screen.</div>
 </div>
 <button 
 onClick={async () => {
 try {
 ...
 className="px-4 py-2 bg-slate-800 hover:bg-slate-800 text-white text-xs font-extrabold uppercase tracking-wider rounded-xl transition-all cursor-pointer border-0 flex items-center gap-2"
 >
 <Download size={13} />
 ...
 <h5 className="text-sm font-black uppercase text-white">PC & Mobile App Installation Center (PWA)</h5>
 </div>
 <p className="text-[11px] text-slate-450 mt-1 font-semibold leading-relaxed">
 ...
 {isInIframe ? (
 <div className="bg-amber-900/20 border border-amber-200/80 p-5 rounded-2xl space-y-3.5 text-left">
 ...
 <div className="bg-slate-900 /80 p-3 rounded-xl border border-amber-150 text-[11px] font-semibold text-white font-semibold leading-relaxed">
 ...
 <div className="bg-teal-900/20 border border-teal-200 p-5 rounded-2xl space-y-3.5 text-left">
 <div className="flex gap-3">
 ...
 * Look at your browser's URL address bar (top-right) for the "Install" icon (the computer monitor symbol or three dots menu ➔ Save and share ➔ Install).
 ...
 <div className="bg-slate-800 border border-slate-150 rounded-2xl p-4 space-y-3 text-left">
 <span className="text-[10px] font-black uppercase text-white font-medium font-medium tracking-wider block">App Eligibility & Diagnostics</span>
 
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
 <div className="bg-slate-900 p-3 rounded-xl border border-white/15 flex items-center justify-between">
 <div>
 <span className="text-[10px] font-bold text-white block">1. Secure Connection (HTTPS)</span>
 <span className="text-[9px] text-slate-450 font-medium">Mandatory browser security requirement</span>
 </div>
 <span className="text-[10px] bg-emerald-900/20 text-emerald-800 px-2 py-0.5 rounded-full font-black">ACTIVE</span>
 </div>

 <div className="bg-slate-900 p-3 rounded-xl border border-white/15 flex items-center justify-between">
 <div>
 <span className="text-[10px] font-bold text-white block">2. Web Manifest (manifest.json)</span>
 <span className="text-[9px] text-slate-450 font-medium">Valid application descriptor registered</span>
 </div>
 <span className="text-[10px] bg-emerald-900/20 text-emerald-800 px-2 py-0.5 rounded-full font-black">VERIFIED</span>
 </div>

 <div className="bg-slate-900 p-3 rounded-xl border border-white/15 flex items-center justify-between">
 <div>
 <span className="text-[10px] font-bold text-white block">3. Offline Service Worker (sw.js)</span>
 <span className="text-[9px] text-slate-450 font-medium">Caching offline assets shell</span>
 </div>
 <span className="text-[10px] bg-emerald-900/20 text-emerald-800 px-2 py-0.5 rounded-full font-black">REGISTERED</span>
 </div>

 <div className="bg-slate-900 p-3 rounded-xl border border-white/15 flex items-center justify-between">
 <div>
 <span className="text-[10px] font-bold text-white block">4. Browser Sandboxed state</span>
 ...
 <span className="text-[10px] bg-emerald-900/20 text-emerald-800 px-2 py-0.5 rounded-full font-black">CLEAN (DIRECT)</span>
 )}
 </div>
 </div>
 </div>
 ...
 <div className="space-y-4">
 <span className="text-[11px] font-black uppercase tracking-wider text-white block">How to Install on Your PC or Mac</span>
 
 <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
 {/* Google Chrome */}
 <div className="bg-slate-900 p-4 rounded-xl border border-white/15 space-y-2 text-left">
 <div className="w-8 h-8 rounded-lg bg-red-900/20 text-red-600 flex items-center justify-center font-bold text-xs uppercase">
 Ch
 </div>
 <h6 className="text-xs font-black text-white">Google Chrome</h6>
 <ol className="text-[10.5px] text-white font-medium font-medium space-y-1.5 list-decimal pl-4 font-semibold leading-relaxed">
 ...
 <h6 className="text-xs font-black text-white">Microsoft Edge</h6>
 <ol className="text-[10.5px] text-white font-medium font-medium space-y-1.5 list-decimal pl-4 font-semibold leading-relaxed">
 ...
 <h6 className="text-xs font-black text-white">Apple Safari (macOS)</h6>
 <ol className="text-[10.5px] text-white font-medium font-medium space-y-1.5 list-decimal pl-4 font-semibold leading-relaxed">
 ...
 <span className="text-[11px] font-black uppercase tracking-wider text-white block">How to Install on Your Smartphone (Android & iOS)</span>
 
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 {/* Android Phone */}
 <div className="bg-slate-900 p-4 rounded-xl border border-white/15 flex gap-4 text-left">
 <div className="w-10 h-10 rounded-xl bg-emerald-900/20 text-emerald-700 flex items-center justify-center shrink-0">
 <Smartphone size={20} />
 </div>
 <div className="space-y-1">
 <h6 className="text-xs font-black text-white">Android Phones (Chrome / Samsung Internet)</h6>
 <p className="text-[10.5px] text-white font-medium font-medium leading-relaxed font-semibold">
 ...
 <div className="space-y-1">
 <h6 className="text-xs font-black text-white">Apple iPhones & iPads (Safari)</h6>
 <p className="text-[10.5px] text-white font-medium font-medium leading-relaxed font-semibold">
 ...
 <h5 className="text-sm font-black uppercase text-white">Google Play Store & Monetization Console</h5>
 </div>
 <p className="text-[11px] text-slate-450 mt-1 font-semibold leading-relaxed">
 ...
 <div className="bg-slate-800 border border-slate-150 p-5 rounded-2xl space-y-4">
 <h6 className="text-[11px] font-black uppercase text-white flex items-center gap-1.5">
 <Sliders size={12} className="text-white font-medium font-medium" />
 1. App Store Deployment Variables
 </h6>
 
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 font-sans">
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1">Android Package Name (Application ID)</label>
 <input
 type="text"
 value={settings.playstorePackageId}
 onChange={(e) => handleUpdate('playstorePackageId', e.target.value)}
 className="border border-white/15 rounded-xl p-2.5 w-full text-xs font-mono font-bold focus:ring-1 focus:ring-blue-500 bg-slate-900 "
 placeholder="e.g. com.company.app"
 />
 <span className="text-[9px] text-white font-medium font-medium font-semibold block mt-1">Unique global ID for Play Store URL listing</span>
 </div>
 <div>
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1">Store Listing App Title</label>
 <input
 type="text"
 value={settings.playstoreAppTitle}
 onChange={(e) => handleUpdate('playstoreAppTitle', e.target.value)}
 className="border border-white/15 rounded-xl p-2.5 w-full text-xs font-bold focus:ring-1 focus:ring-blue-500 bg-slate-900 "
 placeholder="e.g. JR Farm Omni-Estate Manager"
 />
 <span className="text-[9px] text-white font-medium font-medium font-semibold block mt-1">Official user-facing app name on Google Play</span>
 </div>
 </div>

 <div className="border-t border-white/15 pt-3.5">
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-2 font-sans">App Monetization Model Strategy</label>
 ...
 : 'bg-slate-900 border-white/15 hover:border-slate-350 text-white font-semibold'
 }`}
 >
 ...
 <div className="bg-slate-900 border border-white/15 p-4 rounded-xl space-y-3 animate-fadeIn">
 ...
 <div>
 <label className="text-[9px] font-bold text-white font-medium font-medium uppercase block mb-1">AdMob Banner Unit ID</label>
 <input
 type="text"
 value={settings.admobBannerUnitId}
 onChange={(e) => handleUpdate('admobBannerUnitId', e.target.value)}
 className="border border-white/15 rounded-lg p-2 w-full text-[11px] font-mono focus:ring-1 focus:ring-blue-500"
 />
 </div>
 <div>
 <label className="text-[9px] font-bold text-white font-medium font-medium uppercase block mb-1">AdMob Interstitial Unit ID</label>
 <input
 type="text"
 ...
 <div className="bg-slate-900 border border-white/15 p-4 rounded-xl space-y-3 animate-fadeIn w-full sm:w-1/2 font-sans">
 <label className="text-[10px] font-black text-white font-medium font-medium uppercase block mb-1">Price Tier Target (USD)</label>
 <div className="relative">
 <span className="absolute left-3 top-2.5 text-white font-medium font-medium font-bold">$</span>
 <input
 type="number"
 step="0.01"
 value={settings.premiumAppPrice}
 onChange={(e) => handleUpdate('premiumAppPrice', e.target.value)}
 className="border border-white/15 rounded-lg p-2 pl-6 w-full text-xs font-mono font-bold text-white"
 />
 </div>
 </div>
 )}
 ...
 <div className="bg-slate-900 border border-slate-150 p-5 rounded-2xl space-y-4">
 <div className="flex justify-between items-center border-b pb-2">
 <h6 className="text-[11px] font-black uppercase text-white flex items-center gap-1.5">
 <CheckCircle2 size={13} className="text-emerald-600" />
 2. Google Play Store Launch Action Sequence
 </h6>
 <span className="text-[9px] bg-slate-800 px-2.5 py-1 rounded font-mono font-bold text-white font-medium font-medium">
 ...
 <span className={`text-xs font-bold block ${checklistCompleted[task.id] ? 'text-white line-through' : 'text-white'}`}>{task.title}</span>
 ...
 <h6 className="text-[11px] font-black uppercase text-white mt-0.5">Generate Play Store Configuration Asset Pack</h6>
