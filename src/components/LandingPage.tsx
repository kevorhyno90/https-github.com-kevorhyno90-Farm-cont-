...
export function LandingPage({ onEnter }: LandingPageProps) {
 ...
 <div className="flex flex-col gap-3 w-full">
        {auth.currentUser ? (
          <button
            onClick={() => onEnter(auth.currentUser!.uid)}
          ...
          >
            ...
            <div className="relative flex items-center justify-center gap-3">
              <span className="tracking-tight text-white">Enter Dashboard Hub</span>
          ...
          <>
            ...
            >
              ...
              <div className="relative flex items-center justify-center gap-3">
                ...
                <span className="tracking-tight text-white">{loading ? 'Loading...' : 'Google Login (Mobile PWA)'}</span>
                <ArrowRight className="text-white" size={24} />
              </div>
            </button>
          </>
